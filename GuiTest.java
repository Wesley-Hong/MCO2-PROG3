...
public class GuiTest {
    ...
    public static void main(String[] args) {
        ...
        frame.setTitle("Green Property Exchange");
        frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        frame.setSize(1000,700);
        frame.setLayout(new BorderLayout(10, 10));
        frame.getContentPane().setBackground(Color.decode("#4CB572"));
        ...
        Color boxColor = Color.decode("#A1D8B5");
        ...
        for (int i = 1; i <= 4; i ++) {
            ...
            box.addMouseListener(new java.awt.event.MouseAdapter() {
                public void mouseClicked(java.awt.event.MouseEvent e) {
                    ...
                    JFrame newFrame = new JFrame("Property Option " + boxNumber);
                    newFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                    newFrame.setSize(1000, 700);
                    newFrame.setLayout(new BorderLayout(10, 10));
                    newFrame.getContentPane().setBackground(Color.decode("#4CB572"));

                    // Add content to new frame
                    JLabel newLabel = new JLabel("Hello World - Option " + boxNumber, SwingConstants.CENTER);
                    newLabel.setFont(new Font("Times New Roman", Font.PLAIN, 30));
                    newFrame.add(newLabel, BorderLayout.CENTER);

                    // Add back button
                    JButton backButton = new JButton("Back to Main");
                    backButton.addActionListener(backEvent -> {
                        newFrame.dispose(); // Close current frame
                        frame.setVisible(true); // Show main frame again
                    });
                    newFrame.add(backButton, BorderLayout.SOUTH);

                    // Hide old frame and show new frame
                    frame.setVisible(false);
                    newFrame.setVisible(true);
                }

                public void mouseEntered(java.awt.event.MouseEvent e) {
                    box.setBackground(boxColor.brighter());
                }
            ...
            switch (i) {
                case 1 -> boxLabel.setText("Create Property");
                case 2 -> boxLabel.setText("View Property");
                case 3 -> boxLabel.setText("Manage Property");
                case 4 -> boxLabel.setText("Simulate Booking");

            }

            boxLabel.setHorizontalAlignment(SwingConstants.CENTER);
            boxLabel.setFont(new Font("Times New Roman", Font.PLAIN, 20));
            box.add(boxLabel, BorderLayout.CENTER);
